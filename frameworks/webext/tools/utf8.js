...
var utf8 = (function () {
    ...
    function bytesToString(bytes) {
        ...
        while (index < length)
        {
            ...
            else if (((byte >> 5) === 0x06) && (index < length))
            {
                // two bytes
                charCode = ((byte & 0x1f) << 6) | (bytes[index++] & 0x3f);
            }
            else if (((byte >> 4) === 0x0e) && (index + 1 < length))
            {
                // three bytes
            ...
            {
                // Not UTF-8 Data
                console.log("utf8 can't convert");
                return "";
            }
    ...
    return {stringToBytes: stringToBytes, bytesToString: bytesToString};
}());
